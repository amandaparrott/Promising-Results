window.addEventListener('DOMContentLoaded', function () {
    ...
    async function doMath() {
        try {
            ...
            div.innerText = `Ten plus 32 is ${num}. The answer to the meaning of life, the universe, and everything is `;
